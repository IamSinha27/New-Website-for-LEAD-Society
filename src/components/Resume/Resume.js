    ...
    <Container fluid className="resume-section">
      ...
      <Container>
        <Row style={{ justifyContent: "center", position: "relative" }}>
          ...
          <h1>OUR  <strong className="purple">SPONSORS</strong></h1>
        </Row>
        <Row className="resume">
          <Col md={6} className="resume-left">
            <h3 className="resume-title">Sponsor 1</h3>
            {/* <Resumecontent
            ...
            <h3 className="resume-title">Sponsor 2</h3>
            {/* <Resumecontent
          ...
          <Col md={6} className="resume-right">
            <h3 className="resume-title">Sponsor 3</h3>
            {/* <Resumecontent
            ...
            /> */}
            <h3 className="resume-title">Sponsor 4</h3>
            {/* <Resumecontent
              title=""
              content={[
